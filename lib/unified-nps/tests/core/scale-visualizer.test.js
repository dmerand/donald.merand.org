...
describe('ScaleVisualizer', () => {
  ...
  describe('getOptimalRootNote', () => {
    ...
    test('should pick octave at or above lowest string for guitar', () => {
      expect(scaleVisualizer.getOptimalRootNote('E', guitarTuning)).toBe('E2');
      expect(scaleVisualizer.getOptimalRootNote('F', guitarTuning)).toBe('F2');
      expect(scaleVisualizer.getOptimalRootNote('C', guitarTuning)).toBe('C3');
    });

    test('should pick higher octave for mandolin', () => {
      expect(scaleVisualizer.getOptimalRootNote('G', mandolinTuning)).toBe('G3');
      expect(scaleVisualizer.getOptimalRootNote('C', mandolinTuning)).toBe('C4');
      expect(scaleVisualizer.getOptimalRootNote('A', mandolinTuning)).toBe('A3');
    });
  });
